...
static inline uint8_t a_of(pixel_t c) { return (uint8_t)((c >> 24) & 0xFF); }
static inline uint8_t r_of(pixel_t c) { return (uint8_t)((c >> 16) & 0xFF); }
static inline uint8_t g_of(pixel_t c) { return (uint8_t)((c >>  8) & 0xFF); }
static inline uint8_t b_of(pixel_t c) { return (uint8_t)((c >>  0) & 0xFF); }
...
static inline void put_pixel(pixel_t *pixels, size_t width, size_t height,
                             int x, int y, pixel_t color)
{
...
static void draw_rect(pixel_t *pixels, size_t width, size_t height,
...
static void draw_char(pixel_t *pixels, size_t width, size_t height,
                      int px, int py, char c, const text_style_t *st)
{
